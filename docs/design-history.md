...
Per-phase and per-version notes on decisions made where the spec was silent, and incident-driven changes, kept for archaeology. Current behavior and config reference live in the [README](../README.md).
