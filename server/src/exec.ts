...
// Bounded-concurrency map, order-preserving. Background passes fan out over a
// list of independent one-shots (PR reviews, per-risk verifications); running
// them one at a time made the review pipeline the auto-merge ceiling, and
// running them all at once would stampede the model API.
