...
// Supervisor tasks are infrastructure sessions, not director action items.
...
export function needsAttention(task: { state: string; source?: string | null; health?: Health | null; requeued_to?: string | null }): boolean {
