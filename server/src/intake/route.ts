...
// corebeat braindump (a Figma link, "CoreData", "corebeat") from landing in the
// hive repo where the spawned agent can only read, not act.
//
// Signals per project (all case-insensitive):
//   - the project NAME (word-boundary match, e.g. \bcorebeat\b)
...
//     "corebeat.io"), matched as plain substrings so URLs and dotted hosts work.
//
