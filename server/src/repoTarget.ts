...
// `server/src/intake/jira.ts` (a HIVE file) but passed --project for acme,
// because the SUBJECT (a Jira integration) belongs to acme while the CODE
// belongs to hive. Hive dispatched a acme worktree and the child agent was
