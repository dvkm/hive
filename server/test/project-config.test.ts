...
const BAD: [string, unknown, string][] = [
  ...
  ["worktree_seed as a bare string", { worktree_seed: ".env" }, "worktree_seed"],
  ["worktree_warm as a list of strings", { worktree_warm: ["node_modules"] }, "worktree_warm"],
  ["worktree_warm entry with no dir", { worktree_warm: [{ lock: "bun.lock" }] }, "dir"],
  ["worktree_warm entry with an unknown key", { worktree_warm: [{ dir: "node_modules", cmd: "sh" }] }, "cmd"],
