...
// The two row kinds, split failed vs live-unhealthy. The board used to render
// these in its own tray; since HIVE-556 they live only in Needs you, so the
// same fact is not stated twice on /work.
